...
const PetView: FC = () => {
  ...
  useEffect(() => {
    ...
    window.addEventListener("click", (e) => {
      const t = animator.checkBody({ x: e.offsetX, y: e.offsetY });
      switch (t) {
        case "pinch":
        case "head":
          animator.loadAndSetAnimation("touchHead", touchHeadImagePaths);
          break;
        case "body":
          animator.loadAndSetAnimation(
            "touchBody",
            Math.random() > 0.5 ? touchBodyImagePaths1 : touchBodyImagePaths2
          );
          break;
      }
    });
